...
# "inputs.dotfiles.lib.mkNixOS" constructor through the "modules"
# argument so that the target NixOS and home-manager evaluators apply
# the assignment. The schema for the "dotfiles.users.<name>" record is
# declared by the "_users.nix" module in the dotfiles flake, shared by
# all three module classes.
#
# Available options:
