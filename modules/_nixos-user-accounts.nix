...
#
# Every entry under "dotfiles.users" is a user this machine manages,
# so the machine owes that user an account. NixOS holds an account to
# rules that nix-darwin does not—it must declare itself either a
