...
{
  dotfiles.knownProfiles = ["fonts"];

  dotfiles.profileModules.homeManager.fonts = {
    config,
    lib,
    pkgs,
    ...
  ...
  in {
    config = lib.mkIf (activatesProfile "fonts") {
      ...
      home.packages = with pkgs; [
        ...
        # Iconsolata, and Meslo. However, there are additional fonts
        # in the DejaVu family, so we'll pull them in as well.
        #
        # Excluded:
        # - inconsolata
        # - meslo-lgs-nf
