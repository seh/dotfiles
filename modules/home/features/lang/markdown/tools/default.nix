{flakeLib, ...}:
# The Markdown toolchain, active when this configuration expresses the
# "lang/markdown" interest: the "rumdl" program, which lints and
# formats Markdown, and whose configuration file this feature deploys.
flakeLib.mkFeature "lang/markdown/tools" {
    ...
    options = {lib, ...}: {
      options.dotfiles.markdown.rumdlConfigFile = lib.mkOption {
        ...
        description = ''
          ...
          "lang/markdown/tools" feature deploys it at
