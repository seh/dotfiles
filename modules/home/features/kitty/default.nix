{
  ...
  in {
    ...
    config = lib.mkIf cfg.enable {
      # NB: This configuration has to live within a dedicated file
      # with a prescribed name.
      ...
      programs.kitty = {
        ...
        keybindings = {
          ...
          #
          # NB: Matching via the "cmdline" field instead of the
          # "title" field does not work here because the window's
          # "cmdline" value is "/bin/zsh", compared with the
