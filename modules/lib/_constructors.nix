...
# "dotfiles.users.<name>.profiles", "dotfiles.knownProfiles") happen
...
# decide the machine's own configuration.
{
  ...
  #   1. The machine's "forbidProfiles", "forbiddenFeatures", and
  #      "forbiddenInterests" pass through untouched—the "//" below
  #      never names them—and prune every walk, so a user naming a
  #      forbidden thing still does not receive it.
  #   2. The machine's "excludeProfiles", "excludedFeatures", and
  #      "excludedInterests" withhold a name from what it provisions,
        ...
        dotfiles = {
          ...
          host =
            ...
            // {
              ...
              excludedFeatures =
                userCfg.excludedFeatures
                ++ lib.subtractLists entailed.features host.excludedFeatures;
              excludedInterests =
                userCfg.excludedInterests
                ++ lib.subtractLists entailed.features host.excludedInterests;
            };
        };
      })
