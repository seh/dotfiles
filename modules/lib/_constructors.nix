...
# the machine's own configuration.
{
  ...
  # are read together, since a name written under either is read by
  # the same activation walk. What forbidding costs one user. Both
  ...
  #      lists apply unchanged—the "//" operator below leaves them
