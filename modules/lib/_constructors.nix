...
# "dotfiles.user.email", "dotfiles.host.profiles",
...
# read. That keeps assignments close to the evaluator that reads them
# and avoids the flake-parts boundary crossing that the previous proxy
# option ("_flakeOptions") used to bridge.
#
