      ...
      then
        flakeLib.resolveActivation {
          ...
          excluded = {
            ...
            features = userCfg.excludedFeatures ++ host.forbiddenFeatures;
          };
        }
