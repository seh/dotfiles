{lib}: let
  ...
  # in "excludedFeatures" never activates even when its preconditions
  ...
  expandActivation = {
    ...
    activatable =
      lib.filterAttrs (name: _: !(builtins.elem name excludedFeatures)) preconditions;
  ...
  in
    expandActivation {
      ...
      excludedFeatures = excluded.features or [];
