    ...
    options = {
      ...
      excludedFeatures = mkOption {
        ...
        description = ''
          ...
          "forbiddenFeatures" list. A user may exclude a contingent
          ...
          points instead to "forbiddenFeatures", the list that withholds
      ...
      excludedInterests = mkOption {
        ...
        description = ''
          ...
          selection does not undo the "forbiddenInterests" list.
        '';
      };
      forbiddenFeatures = mkOption {
        ...
        description = ''
          ...
          absolute counterpart to the "excludedFeatures" list, which
      ...
      forbiddenInterests = mkOption {
        ...
        description = ''
          ...
          the absolute counterpart to the "excludedInterests" list,
