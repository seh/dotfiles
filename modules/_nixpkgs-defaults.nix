...
# "./lib/_constructors.nix"). Centralizing it here keeps both sites in
# lockstep: any nixpkgs "config" adjustment made for the flake-parts
# pipeline is seen equally by constructor-built systems.
#
