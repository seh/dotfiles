...
final: prev: {
  ...
  # value of the "dotfiles.lix.channel" option, but this overlay runs
  # at nixpkgs instantiation time and cannot access flake-level
  # options. A caller that changes the channel option cannot easily
  # rectify the resulting divergence here short of supplying a
  # replacement overlay.
  #
