    ...
    config = lib.mkMerge [
      ...
      (lib.mkIf (hasTag "apps") {
        ...
        homebrew = {
          ...
          casks = [
            # TODO(seh): Once the GUI becomes viable to install via
            # Nix, remove this in favor of that.
            "1password"
