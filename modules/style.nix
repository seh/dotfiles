    ...
    pre-commit.settings = {
      hooks = {
        ...
        trim-trailing-whitespace = {
          ...
          # In a patch, a leading space marks a line as unchanged. On
          # a blank unchanged line that space is also the last
          # character, which this hook reads as trailing whitespace
          # and deletes.
          excludes = [
            "\\.diff$"
            "\\.patch$"
