...
# a host's selections and in the implication graph.
{
  ...
  roles = [
    ...
    }
    {
      ...
      excludeOption = "dotfiles.host.excludedFeatures";
      forbidOption = "dotfiles.host.forbiddenFeatures";
    }
  ];
  ...
  # computed once per evaluator by "modules/_activation.nix" and
  # shared through the "_implications" option.
