...
# "dotfiles._knownProfiles" for the rationale.
{
  ...
  # "all" umbrella already omits unsupported profiles (see
  # "cascadesFor" in "modules/lib/_cascades.nix"); this assertion
  # rejects a host whose resolved closure reaches one anyway, such as
  # by declaring it directly in "dotfiles.host.profiles". A host with
  # a null "platform" is not checked, since its operating system is
  # unknown.
