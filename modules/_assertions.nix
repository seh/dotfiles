...
# machine alone.
{
  ...
  # the machine level; each one but "forbiddenFeatures" and
  # "forbiddenInterests" also has a per-user counterpart under
  ...
  contingentExclusionAssertion = {
    ...
    message = ''
      Resolving ${hostLabel}: "${hostOption "excludedFeatures"}" lists
      ...
      "${hostOption "forbiddenFeatures"}" instead.
    '';
  };
