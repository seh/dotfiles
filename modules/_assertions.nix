...
# a name that configures the machine alone.
{
  ...
  # An interest may imply only interests, never a feature or a
  # profile, so the want-world and the configuration-world do not
  # cross through implication.
  ...
  activeNames =
    config.dotfiles._resolved.activeProfiles ++ config.dotfiles._resolved.activeFeatures;
