...
in {
      ...
      type = types.submodule (
        {config, ...}: {
          ...
          config = let
            ...
            activeFeatures = lib.subtractLists config.excludedFeatures expanded.features;
          in {
  ...
  config.dotfiles._resolved = {
    unreachableTags = lib.subtractLists config.dotfiles._resolved.effectiveTags config.dotfiles._knownTags;
