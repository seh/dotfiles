...
in {
  options.dotfiles = {
    ...
    host = mkOption {
        ...
        options = {
          ...
          profiles = mkOption {
            ...
            description = ''
              ...
              which produces "_resolved.activeProfiles" and
              "_resolved.activeFeatures".
            '';
          };
          features = mkOption {
            type = types.listOf types.str;
      ...
      description = ''
        ...
        "features", "excludeProfiles", and "excludedFeatures" lists
      ...
      type = types.submodule {
        options = {
          ...
          activeFeatures = mkOption {
            ...
            description = ''
              ...
              "host.excludeProfiles" / "host.excludedFeatures" from
        ...
        config = let
          ...
          prunedSeed = {
            ...
            features = lib.subtractLists host.excludedFeatures host.features;
          };
    ...
    # declared once at the host level and hook-able by any class whose
    ...
    # the same name can be declared on a NixOS or darwin host;
  ...
  # name "n" in "excludeProfiles" (or "excludedFeatures"), recompute
