...
in {
  ...
  config.dotfiles._resolved = {
    effectiveTags = lib.subtractLists config.dotfiles.excludeTags config.dotfiles._resolved.tags;
    hasTag = tag: builtins.elem tag config.dotfiles._resolved.effectiveTags;
  };
}
