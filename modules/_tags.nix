...
in {
      ...
      type = types.submodule (
        ...
        in {
          ...
          config = let
            ...
            activeFeatures = lib.subtractLists hostCfg.excludedFeatures expanded.features;
          in {
  ...
  config.dotfiles._resolved = {
    unreachableProfiles = lib.subtractLists config.dotfiles._resolved.activeProfiles config.dotfiles._knownProfiles;
    unreachableFeatures = lib.subtractLists config.dotfiles._resolved.activeFeatures config.dotfiles._knownFeatures;
  };
}
