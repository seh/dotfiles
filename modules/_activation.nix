...
# an option's definitions, which is why none of them declares one.
{
  ...
  withForbidden = excluded:
    excluded
    ++ ofKind config.dotfiles._knownFeatures host.forbiddenFeatures
    ++ ofKind config.dotfiles._knownInterests host.forbiddenInterests;
      ...
      type = types.submodule {
        ...
        in {
          ...
          withheldFeatures = let
            ...
            isForbidden = name: builtins.elem name host.forbiddenFeatures;
