...
# an option's definitions, which is why none of them declares one.
{
  ...
  # feature's name in the "excludedInterests" or "forbiddenInterests"
  # list (or an interest's in the feature lists) prunes nothing,
  # exactly as the complaint says to expect.
...
in {
                ...
                options = {
                  ...
                  excludedBy = mkOption {
                    ...
                    description = ''
                      ...
                      "excludedFeatures" list, which the propagation
                  ...
                  forbidden = mkOption {
                    ...
                    description = ''
                      ...
                      the walk lets "forbiddenFeatures" forbid features
                      alone and "forbiddenInterests" forbid interests
                      alone, so a feature's name in the
                      "forbiddenInterests" list is a kind mismatch that
        ...
        in {
          ...
          latentFeatures =
            lib.mapAttrs (name: preconditions: {
              ...
              # Only the "excludedFeatures" lists can withhold a
  ...
  config = let
    ...
    # which consults each list for its own kind alone. A name written
    # under the wrong list is a kind mismatch, which the assertions in
    # the "modules/_assertions.nix" file reject outright and the walk
    # ignores.
    #
