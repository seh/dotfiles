...
# where it stays empty.
{
  ...
  # "host.forbidProfiles"/"host.forbiddenFeatures" prune every
  ...
  options.dotfiles = {
    host = mkOption {
        ...
        options = {
          ...
          forbiddenFeatures = mkOption {
            ...
            description = ''
              ...
              user's, so it activates nowhere and no user receives it.
              Forbidding is the machine-wide counterpart to the
              per-selector "excludedFeatures", which prunes only its own
              selector's walk.
            '';
          };
        };
      ...
      description = ''
        ...
        the machine-wide "forbidProfiles"/"forbiddenFeatures" veto. The
