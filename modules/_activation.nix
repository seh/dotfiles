...
# where it stays empty.
{
  ...
  # exclusions: "host.forbidProfiles"/"host.forbiddenFeatures" prune
        ...
        _: userCfg:
          flakeLib.resolveActivation {
            ...
            excluded = withForbidden {
              ...
              features = userCfg.excludedFeatures;
            };
          }
      )
...
in {
  ...
  options.dotfiles = {
    host = mkOption {
        ...
        options = {
          ...
          forbiddenFeatures = mkOption {
            ...
            description = ''
              ...
              every user's, so it activates nowhere and no user
              receives it. Forbidding is the machine-wide counterpart
              to the per-selector "excludedFeatures", which prunes only
              its own selector's walk.
            '';
          };
        };
      ...
      description = ''
        ...
        the machine-wide "forbidProfiles"/"forbiddenFeatures" lists. The
                ...
                options = {
                  ...
                  excluded = mkOption {
                    ...
                    description = ''
                      ...
                      own "host.excludedFeatures" list.
                    '';
                  };
                };
              }
  ...
  # "excludeProfiles" (or "excludedFeatures"), recompute the machine's
  ...
  config = let
    ...
    redundantFeatures = redundantOf "features" config.dotfiles._featureUniverse host.excludedFeatures;
